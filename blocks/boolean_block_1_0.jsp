...
<%-- Block Init End --%>
	<%-- Block boolean_block_V1_0 Start [ --%>
	<xhtml:block>
		<fieldset>
		  ...
		  <fs:blockContent>
		  	...
		  	<ui:blockContentRowDiv fieldsInRow="Boolean" blockRowNumber="1" styleclass="row">
		  		<ui:inlineMessagesCssClassesCellDiv id="Boolean" name="Boolean" styleclass="cell" additionalLayoutClasses="cell100 label17 field83 fieldwidthXX controltype_checkbox" >
		  			<%-- Field Content Boolean Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="Boolean" title="Boolean">Sollen weiere Anträge erzeugt werden:</fs:label>
