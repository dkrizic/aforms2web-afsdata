	...
	<xhtml:block>
		<fieldset>
		  ...
		  <fs:blockContent>
		  	...
		  	<ui:blockContentRowDiv fieldsInRow="xxx" blockRowNumber="1" styleclass="row">
		  		<ui:inlineMessagesCssClassesCellDiv id="xxx" name="xxx" styleclass="cell" additionalLayoutClasses="cell50 label17 field33 fieldwidthXX controltype_text" >
		  			<%-- Field Content xxx Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="xxx" title="xxx">xxx</fs:label>
		  						<fs:ifFieldHelplinkExists for="xxx" position="label">
		  							<div class="info">
		  						   		<fs:fieldhelplink styleclass="infoI" for="xxx">i</fs:fieldhelplink> 			
		  							</div>
		  					...
		  					<div class="field">
		  							...
		  							size="35"/>
		  							<%-- Text Control End --%>
		  						<fs:ifFieldHelplinkExists for="xxx" position="field">
		  							<div class="info">
		  								<fs:fieldhelplink styleclass="infoI" for="xxx">i</fs:fieldhelplink> 			
		  							</div>
		  						</fs:ifFieldHelplinkExists>
		  						<fs:ifFieldMessageExists for="xxx" position="field">
		  							<div class="message">
		  								<fs:afsFieldMessageOut for="xxx" />
		  							</div>
		  						</fs:ifFieldMessageExists>
		  					</div>
		  					<%-- Field Control Cell End --%>
		  					<%-- Field Info Cell Start --%>
		  						<fs:ifFieldHelplinkExists for="xxx" position="cell">
		  							<div class="info">
		  						   		<fs:fieldhelplink styleclass="infoI" for="xxx">i</fs:fieldhelplink> 			
		  							</div>
		  						</fs:ifFieldHelplinkExists>
		  					...
		  					<fs:ifFieldMessageExists for="xxx" position="cell">
		  						<div class="message">
		  							<fs:afsFieldMessageOut for="xxx" />
		  						</div>
		  					</fs:ifFieldMessageExists>
		  					<%-- Field Message Cell End --%>
		  				</div><%-- Field Content xxx End --%>
