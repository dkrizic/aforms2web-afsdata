	...
	<xhtml:block>
		<fieldset>
		  ...
		  <fs:blockContent>
		  	...
		  	<ui:blockContentRowDiv fieldsInRow="Texarea" blockRowNumber="1" styleclass="row">
		  		<ui:inlineMessagesCssClassesCellDiv id="Texarea" name="Texarea" styleclass="cell" additionalLayoutClasses="cell100 label17 field83 fieldwidthXX controltype_textarea" >
		  			<%-- Field Content Texarea Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="Texarea" title="Teilen Sie uns mit wie Sie auf uns aufmerksam geworden sind?">Wie sind Sie auf uns aufmerksam geworden?</fs:label>
		  						<fs:ifFieldHelplinkExists for="Texarea" position="label">
		  							<div class="info">
		  						   		<fs:fieldhelplink styleclass="infoI" for="Texarea">i</fs:fieldhelplink> 			
		  							</div>
		  					...
		  					<div class="field">
		  							<%-- Textarea Control Start --%>

		  								<ui:textarea
		  									id="Texarea" 
		  									name="Texarea" 
		  							styleclass="standard" 
		  							title="Teilen Sie uns mit wie Sie auf uns aufmerksam geworden sind?" 
		  							cols="70" 
		  							rows="5"/>
		  							<%-- Textarea Control End --%>
		  						<fs:ifFieldHelplinkExists for="Texarea" position="field">
		  							<div class="info">
		  								<fs:fieldhelplink styleclass="infoI" for="Texarea">i</fs:fieldhelplink> 			
		  							</div>
		  						</fs:ifFieldHelplinkExists>
		  						<fs:ifFieldMessageExists for="Texarea" position="field">
		  							<div class="message">
		  								<fs:afsFieldMessageOut for="Texarea" />
		  							</div>
		  						</fs:ifFieldMessageExists>
		  					</div>
		  					<%-- Field Control Cell End --%>
		  					<%-- Field Info Cell Start --%>
		  						<fs:ifFieldHelplinkExists for="Texarea" position="cell">
		  							<div class="info">
		  						   		<fs:fieldhelplink styleclass="infoI" for="Texarea">i</fs:fieldhelplink> 			
		  							</div>
		  						</fs:ifFieldHelplinkExists>
		  					...
		  					<fs:ifFieldMessageExists for="Texarea" position="cell">
		  						<div class="message">
		  							<fs:afsFieldMessageOut for="Texarea" />
		  						</div>
		  					</fs:ifFieldMessageExists>
		  					<%-- Field Message Cell End --%>
		  				</div><%-- Field Content Texarea End --%>
