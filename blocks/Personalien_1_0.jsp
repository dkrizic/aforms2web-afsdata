	...
	<xhtml:block>
		<fieldset>
		  ...
		  <fs:blockContent>
		  	...
		  	<ui:blockContentRowDiv fieldsInRow="Liste_Kunde" blockRowNumber="1" styleclass="row">
		  		<ui:inlineMessagesCssClassesCellDiv id="Liste_Kunde" name="Liste_Kunde" styleclass="cell" additionalLayoutClasses="cell100 label17 field83 fieldwidthXX controltype_radioGroup" >
		  			<%-- Field Content Liste_Kunde Start --%>
		  				<div class="cellinner">
		  					...
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="Liste_Kunde" title="Sind Sie Privatkunde oder Businesskunde">Sie sind?</fs:label>
		  		...
		  		<ui:inlineMessagesCssClassesCellDiv id="Anrede" name="Anrede" styleclass="cell" additionalLayoutClasses="cell100 label17 field83 fieldwidthXX controltype_select" >
		  			<%-- Field Content Anrede Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="Anrede" title="Bitte die Anrede wählen">Anrede</fs:label>
		  		...
		  		<ui:inlineMessagesCssClassesCellDiv id="vorname" name="vorname" styleclass="cell" additionalLayoutClasses="cell50 label17 field33 fieldwidthXX controltype_text" >
		  			...
		  			<%-- Field Content nachname Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="nachname" title="Nachname eingeben">Nachname</fs:label>
		  		...
		  		<ui:inlineMessagesCssClassesCellDiv id="geburtsdatum" name="geburtsdatum" styleclass="cell" additionalLayoutClasses="cell50 label17 field33 fieldwidthXX controltype_text" >
		  			<%-- Field Content geburtsdatum Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="geburtsdatum" title="Geburtsdatum eingeben">Geburtsdatum</fs:label>
		  			...
		  			<%-- Field Content nation Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="nation" title="Nationalität eingeben">Nationalität</fs:label>
		  		...
		  		<ui:inlineMessagesCssClassesCellDiv id="PLZ" name="PLZ" styleclass="cell" additionalLayoutClasses="cell50 label17 field33 fieldwidthXX controltype_text" >
		  			<%-- Field Content PLZ Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="PLZ" title="Postleitzahl eingeben">PLZ</fs:label>
		  			...
		  			<%-- Field Content ort Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="ort" title="Ort eingeben">Ort</fs:label>
		  		...
		  		<ui:inlineMessagesCssClassesCellDiv id="strasse" name="strasse" styleclass="cell" additionalLayoutClasses="cell50 label17 field33 fieldwidthXX controltype_text" >
		  			<%-- Field Content strasse Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="strasse" title="Straße eingeben">Straße</fs:label>
		  	...
		  	</ui:blockContentRowDiv><ui:blockContentRowDiv fieldsInRow="Picker" blockRowNumber="10" styleclass="row">
		  		<ui:inlineMessagesCssClassesCellDiv id="Picker" name="Picker" styleclass="cell" additionalLayoutClasses="cell33 label17 field16 fieldwidthXX controltype_datepicker" >
		  	...
		  	</ui:blockContentRowDiv><ui:blockContentRowDiv fieldsInRow="Picker_4 Picker_2 Picker_3" blockRowNumber="11" styleclass="row">
		  		<ui:inlineMessagesCssClassesCellDiv id="Picker_4" name="Picker_4" styleclass="cell" additionalLayoutClasses="cell33 label17 field16 fieldwidthXX controltype_text" >
		  			<%-- Field Content Picker_4 Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="Picker_4" title="Picker_4">Picker_4</fs:label>
		  						<fs:ifFieldHelplinkExists for="Picker_4" position="label">
		  							<div class="info">
		  						   		<fs:fieldhelplink styleclass="infoI" for="Picker_4">i</fs:fieldhelplink> 			
		  							</div>
		  						</fs:ifFieldHelplinkExists>
		  					</div>
		  					<%-- FieldContent Label End --%>
		  					...
		  					<div class="field">
		  							...
		  							size="40"/>
		  							<%-- Text Control End --%>
		  						<fs:ifFieldHelplinkExists for="Picker_4" position="field">
		  							<div class="info">
		  								<fs:fieldhelplink styleclass="infoI" for="Picker_4">i</fs:fieldhelplink> 			
		  							</div>
		  						</fs:ifFieldHelplinkExists>
		  						<fs:ifFieldMessageExists for="Picker_4" position="field">
		  							<div class="message">
		  								<fs:afsFieldMessageOut for="Picker_4" />
		  							</div>
		  						</fs:ifFieldMessageExists>
		  					</div>
		  					<%-- Field Control Cell End --%>
		  					<%-- Field Info Cell Start --%>
		  						<fs:ifFieldHelplinkExists for="Picker_4" position="cell">
		  							<div class="info">
		  						   		<fs:fieldhelplink styleclass="infoI" for="Picker_4">i</fs:fieldhelplink> 			
		  							</div>
		  						</fs:ifFieldHelplinkExists>
		  					<%-- Field Info Cell End --%>
		  					<%-- Field Message Cell Start --%>
		  					<fs:ifFieldMessageExists for="Picker_4" position="cell">
		  						<div class="message">
		  							<fs:afsFieldMessageOut for="Picker_4" />
		  						</div>
		  					</fs:ifFieldMessageExists>
		  					<%-- Field Message Cell End --%>
		  				</div><%-- Field Content Picker_4 End --%>
		  		</ui:inlineMessagesCssClassesCellDiv><ui:inlineMessagesCssClassesCellDiv id="Picker_2" name="Picker_2" styleclass="cell" additionalLayoutClasses="cell33 label17 field16 fieldwidthXX controltype_text" >
		  		...
		  		</ui:inlineMessagesCssClassesCellDiv><ui:inlineMessagesCssClassesCellDiv id="Picker_3" name="Picker_3" styleclass="cell" additionalLayoutClasses="cell33 label17 field16 fieldwidthXX controltype_datepicker" >
		  			<%-- Field Content Picker_3 Start --%>
		  				<div class="cellinner">
		  					<%-- FieldContent Label Start --%>
		  					<div class="label" >
		  						<fs:label addStatusImages="true" for="Picker_3" title="Picker_3">Picker_3</fs:label>
		  						<fs:ifFieldHelplinkExists for="Picker_3" position="label">
		  							<div class="info">
		  						   		<fs:fieldhelplink styleclass="infoI" for="Picker_3">i</fs:fieldhelplink> 			
		  							</div>
		  						</fs:ifFieldHelplinkExists>
		  					</div>
		  					<%-- FieldContent Label End --%>
		  					...
		  					<div class="field">
		  							...
		  							size="40" />
		  							<%-- datepicker Control End --%>
		  						<fs:ifFieldHelplinkExists for="Picker_3" position="field">
		  							<div class="info">
		  								<fs:fieldhelplink styleclass="infoI" for="Picker_3">i</fs:fieldhelplink> 			
		  							</div>
		  						</fs:ifFieldHelplinkExists>
		  						<fs:ifFieldMessageExists for="Picker_3" position="field">
		  							<div class="message">
		  								<fs:afsFieldMessageOut for="Picker_3" />
		  							</div>
		  						</fs:ifFieldMessageExists>
		  					</div>
		  					<%-- Field Control Cell End --%>
		  					<%-- Field Info Cell Start --%>
		  						<fs:ifFieldHelplinkExists for="Picker_3" position="cell">
		  							<div class="info">
		  						   		<fs:fieldhelplink styleclass="infoI" for="Picker_3">i</fs:fieldhelplink> 			
		  							</div>
		  						</fs:ifFieldHelplinkExists>
		  					<%-- Field Info Cell End --%>
		  					<%-- Field Message Cell Start --%>
		  					<fs:ifFieldMessageExists for="Picker_3" position="cell">
		  						<div class="message">
		  							<fs:afsFieldMessageOut for="Picker_3" />
		  						</div>
		  					</fs:ifFieldMessageExists>
		  					<%-- Field Message Cell End --%>
		  				</div><%-- Field Content Picker_3 End --%>
		  		</ui:inlineMessagesCssClassesCellDiv>
